import re, sys
custlist=[
    {'name':'aaa', 'gender':'M', 'email':'aaaaa@aaaaa.aaa', 'birthyear':2000},
    {'name':'bbb', 'gender':'M', 'email':'bbbbb@bbbbb.bbb', 'birthyear':2000},
    {'name':'ccc', 'gender':'F', 'email':'ccccc@cccc.ccc', 'birthyear':2000},
    {'name':'ddd', 'gender':'F', 'email':'ddddd@ddddd.ddd', 'birthyear':2000},
]
page=3

def exe(choice, custlist, page):
    if choice=='I':
        custlist , page = insertData(custlist, page)
    
    elif choice=='C':
        curSearch(custlist, page)
    
    elif choice=='P':
        page = preSearch(custlist, page)

    elif choice=='N':
        page = nextSearch(custlist, page)

    elif choice=='U':
        custlist= updateData(custlist)
    
    elif choice=='D':
        custlist, page = deleteData(custlist, page)
...
>>>''').upper()
    ...
    custlist, page = exe(choice, custlist, page)